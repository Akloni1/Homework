...
class FifthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val more15 = view.findViewById<Button>(R.id.more15)
        more15.setOnClickListener {
        ...
        val less15 = view.findViewById<Button>(R.id.less15)
        less15.setOnClickListener {
            findNavController().navigate(
                R.id.action_fifthFragment_to_ninthFragment,
                null,
                navOptions {
                    anim {
                        enter = R.anim.fade_in
